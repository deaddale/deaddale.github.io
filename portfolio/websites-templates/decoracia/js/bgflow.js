	...
	(function($) {
		...
		$.fn.initBgImage = function() {
			...
			if (sw/sh > 1.777777777777778) {
				...
				var iw = sw;
				var ih = parseInt(sw / 1.777777777777778);
				...
				var iw = parseInt(sh * 1.777777777777778);
				var ih = sh;
			...
			$('#jFlow-bg-img, .bx-wrapper, .bx-window, #pano, #pano > div, #pano div > img').css({'width': iw, 'height': ih});
